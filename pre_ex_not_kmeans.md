...
## 実験手法(先行研究の説明が長いから本研究は静的解析とLLMの比較してどっちのが精度の高い誤答分類できるかを検証するよってことを言う)
...
(難易度は★2 ~ ★7あり今回は一番難易度の低い★2を取り扱ってるよ)
...
本研究の主張としてはLLMより静的解析の方が優れているよ
でもシステム化するときハルシネーション気を付けないいけないね
...
**1. 静的解析とLLMのハイブリッド手法の検討(実行時間考慮していないことを今後の展望で言う)**
<div class="box">
