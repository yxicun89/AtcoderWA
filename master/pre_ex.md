...
| ジャンル | アプローチ | 特徴 | 主な課題 |
|:----:|:---:|:-----|:--------|
| 静的 | **構造的** | トークン,ASTなど**構文的特徴**を抽出| フォーマット変更に敏感<br>動作や意味の考慮が不足|
...
<!-- ここに図を挿入: 様々な位置に配置された丸(データ点)を3色(赤・青・緑)でランダムに色分け -->
...
<!-- ここに図を挿入: Step1の配色に加えて、各色のグループの中心に★マーク(重心)を表示 -->

</div>

<div class="box">

各クラスタ(色)ごとに,そのグループに属するデータの**重心**を計算
...
<!-- ここに図を挿入: 各データ点が最も近い★(重心)の色に変わる様子を表示 -->

</div>

<div class="box">

各データポイントについて,**最も近い重心**を持つクラスタに再度割り当て
...
<!-- ここに図を挿入: 重心が新しい位置に移動し、データが綺麗に3つのグループに分かれた最終状態 -->

</div>

<div class="box">

重心を**再計算**し,Step 3~4を**重心が動かなくなるまで繰り返す**<br>
...
- API経由での利用による**システム化**の実現
- **高性能**なコードの意味理解による分類精度の向上
- モデルの進化による,**コストパフォーマンスの向上**が期待
